...
export default function Tutorhub() {
  ...
  return (
    <div className={s.container}>
      <h2 className={s.title}>TutorHub</h2>
            ...
            {usersWithPosts
              ...
              .map((u) => (
                <div 
                  key={u.userId} 
                  className={s.userStory}
                  onClick={() => navigate(`/tutorhub/user/${u.userId}`)}
                >
      ...
      {userId && (
        <div className={s.profileHeader}>
          ...
          <button onClick={() => navigate("/tutorhub")} className={s.backButton}>
            ← Zurück zum Feed
          </button>
        </div>
      )}
            ...
            >
              ...
              <div className={s.postHeader}>
                <div 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate(`/tutorhub/user/${post.authorId}`);
                  }}
                >
                  <div className={s.avatar}>
                    {post.authorAvatar ? (
